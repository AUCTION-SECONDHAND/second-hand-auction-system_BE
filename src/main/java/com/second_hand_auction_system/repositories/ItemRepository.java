...
public interface ItemRepository extends JpaRepository<Item, Integer> {
    ...
    Page<Item> findAllBySubCategory_SubCategoryIdAndAuctions_Status(
    ...
    @Query("SELECT i FROM Item i " +
            ...
            "WHERE (:itemName IS NULL OR :itemName = '' OR LOWER(i.itemName) LIKE LOWER(CONCAT('%', :itemName, '%'))) " +
    ...
    Item findByAuctions_AuctionId(Integer auction);

    Page<Item> findAllByUserIdAndAuctionsStatus(Integer user_id, AuctionStatus auctionStatus, Pageable pageable);
