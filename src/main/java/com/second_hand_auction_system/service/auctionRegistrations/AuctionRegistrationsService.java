...
//        Wallet wallet = walletCustomerRepository.findByUserId(requester.getId()).orElse(null);
...
//            assert walletType != null;
//            walletType.setBalance(walletType.getBalance() + depositAmount);
//
//            // Lưu giao dịch
