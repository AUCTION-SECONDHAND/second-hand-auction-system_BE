...
public class SellerInformationConverter {
    ...
    public static SellerInformationResponse convertToResponseWithFeedback(SellerInformation sellerInformation, Page<FeedbackResponse> feedbackResponses) {
        ...
        return SellerInformationResponse.builder()
                ...
                .totalStars(Math.round(totalStars * 10.0) / 10.0)
                .feedbackList(feedbackList)
                .rating1Percentage(Math.round(ratingPercentages[0] * 10.0) / 10.0)
                .rating2Percentage(Math.round(ratingPercentages[1] * 10.0) / 10.0)
                .rating3Percentage(Math.round(ratingPercentages[2] * 10.0) / 10.0)
                .rating4Percentage(Math.round(ratingPercentages[3] * 10.0) / 10.0)
                .rating5Percentage(Math.round(ratingPercentages[4] * 10.0) / 10.0)
